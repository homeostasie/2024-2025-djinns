...
\textbf{Périmètre : } \dotfill  \columnbreak
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{6x7-aires-perimetres/ex3.pdf}
  \end{figure}
\end{multicols}
...
\thispagestyle{empty}
\pgfplotsset{minor grid style = {dashed,color=black}}
\pgfplotsset{major grid style = {solid,color=black}}
